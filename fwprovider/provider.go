...
func (p *proxmoxProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		apt.NewShortRepositoryResource,
		...
		network.NewShortLinuxVLANResource,
		nodes.NewACMECertificateResource,
		nodes.NewShortACMECertificateResource,
		...
		sdnzone.NewQinQShortResource,
		sdnzone.NewSimpleResource,
		sdnzone.NewSimpleShortResource,
		sdnzone.NewVLANResource,
		sdnzone.NewVLANShortResource,
		sdnzone.NewVXLANResource,
		sdnzone.NewVXLANShortResource,
		sdnfabric.NewOpenFabricResource,
		sdnfabric.NewOpenFabricShortResource,
		sdnfabric.NewOSPFResource,
		sdnfabric.NewOSPFShortResource,
		...
		storage.NewDirectoryStorageShortResource,
		storage.NewLVMPoolStorageResource,
		storage.NewLVMPoolStorageShortResource,
		storage.NewLVMThinPoolStorageResource,
		storage.NewLVMThinPoolStorageShortResource,
		storage.NewNFSStorageResource,
		storage.NewNFSStorageShortResource,
		storage.NewProxmoxBackupServerStorageResource,
		storage.NewProxmoxBackupServerStorageShortResource,
...
func (p *proxmoxProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		apt.NewShortRepositoryDataSource,
		...
		sdnsubnet.NewShortDataSource,
		sdnvnet.NewDataSource,
		sdnvnet.NewShortDataSource,
		sdnvnet.NewVNetsDataSource,
		sdnvnet.NewShortVNetsDataSource,
		sdnzone.NewEVPNDataSource,
		sdnzone.NewEVPNShortDataSource,
		sdnzone.NewQinQDataSource,
		sdnzone.NewQinQShortDataSource,
		sdnzone.NewSimpleDataSource,
		sdnzone.NewSimpleShortDataSource,
		sdnzone.NewVLANDataSource,
		sdnzone.NewVLANShortDataSource,
		sdnzone.NewVXLANDataSource,
		sdnzone.NewVXLANShortDataSource,
		sdnzone.NewZonesDataSource,
		sdnzone.NewZonesShortDataSource,
		sdnfabric.NewOpenFabricDataSource,
		sdnfabric.NewOpenFabricShortDataSource,
		sdnfabric.NewOSPFDataSource,
		sdnfabric.NewOSPFShortDataSource,
