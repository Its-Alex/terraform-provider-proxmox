...
//go:generate cp ./build/docs-gen/data-sources/acme_account.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/acme_accounts.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/acme_plugin.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/acme_plugins.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/data-sources/apt_repository.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/virtual_environment_apt_standard_repository.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/apt_standard_repository.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/data-sources/haresource.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/haresources.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/data-sources/hardware_mapping_dir.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/hardware_mapping_pci.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/hardware_mapping_usb.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/hardware_mappings.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/data-sources/virtual_environment_sdn_fabric_openfabric.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/data-sources/sdn_fabric_ospf.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_subnet.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_vnet.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_vnets.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_zone_evpn.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_zone_qinq.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_zone_simple.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_zone_vlan.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_zone_vxlan.md ./docs/data-sources/
//go:generate cp ./build/docs-gen/data-sources/sdn_zones.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/resources/acme_account.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/acme_dns_plugin.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/virtual_environment_acme_account.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/virtual_environment_acme_certificate.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/acme_certificate.md ./docs/resources/
...
//go:generate cp ./build/docs-gen/resources/node_disk_zfs.md ./docs/resources/
...
//go:generate cp ./build/docs-gen/resources/download_file.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/hagroup.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/haresource.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/harule.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/virtual_environment_hagroup.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/hardware_mapping_dir.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/hardware_mapping_pci.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/hardware_mapping_usb.md ./docs/resources/
...
//go:generate cp ./build/docs-gen/resources/oci_image.md ./docs/resources/
...
//go:generate cp ./build/docs-gen/resources/virtual_environment_sdn_fabric_openfabric.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/virtual_environment_sdn_fabric_ospf.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/virtual_environment_sdn_fabric_node_openfabric.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/virtual_environment_sdn_fabric_node_ospf.md ./docs/resources/
...
//go:generate cp ./build/docs-gen/resources/sdn_zone_vlan.md ./docs/resources/
//go:generate cp ./build/docs-gen/resources/sdn_zone_vxlan.md ./docs/resources/
